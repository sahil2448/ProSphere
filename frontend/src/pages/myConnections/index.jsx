...
function MyConnectionsPage() {
  ...
  return (
    <UserLayout>
      <DashboardLayout>
        <ScrollArea className="p-0 h-full w-full">
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              ...
                              className="bg-black cursor-pointer text-white hover:bg-gray-800 px-4 py-2 rounded-md font-medium transition-colors"
                            >
                              Accept
                            </Button>
                          </div>
